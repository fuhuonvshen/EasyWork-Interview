...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            minutes::meeting::update_meeting_interview_info,
            minutes::meeting::save_interview_assessment,
            minutes::meeting::get_interview_assessment,
            ...
            agent::commands::agent_update_conversation_meta,
